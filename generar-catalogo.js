            ...
            for (const alumno of alumnos) {
                ...
                for (const trabajo of trabajos) {
                    ...
                    proyectos.push({
                        ...
                        descripcion:
                            datosManuales.descripcion,

                        foto: foto,

                        visible:
                            datosManuales.visible,
...
function ordenarProyectos(proyectos) {
    ...
    return proyectos.sort((a, b) => {
        ...
        // Comisión
        const diferenciaComision =
            a.comision.localeCompare(
                b.comision
            );
        ...
        // Trabajo
        return a.trabajo.localeCompare(
            b.trabajo
        );
    });
}
...
function generarCatalogo() {
    ...
    console.log(
        "📄 catalogo.json generado correctamente."
    );
